...
document.getElementsByClassName("time")[0].innerText =
  "Thời gian chơi: " + time;
document.getElementsByClassName("fasttime")[0].innerText =
  "Thời gian nhanh nhất: " + fasttime;
document
...
document
  .getElementsByClassName("front css")[0]
  .addEventListener("click", function () {
    s1 = "css";
  });
document
  .getElementsByClassName("front css")[1]
  .addEventListener("click", function () {
    s2 = "css";
  });
document
  .getElementsByClassName("front jquery")[0]
  .addEventListener("click", function () {
    s1 = "jquery";
  });
document
  .getElementsByClassName("front jquery")[1]
  .addEventListener("click", function () {
    s2 = "jquery";
  });
document
  .getElementsByClassName("front js")[0]
  .addEventListener("click", function () {
    s1 = "js";
  });
document
  .getElementsByClassName("front js")[1]
  .addEventListener("click", function () {
    s2 = "js";
  });
document
  .getElementsByClassName("front nodejs")[0]
  .addEventListener("click", function () {
    s1 = "nodejs";
  });
document
  .getElementsByClassName("front nodejs")[1]
  .addEventListener("click", function () {
    s2 = "nodejs";
  });
document
  .getElementsByClassName("front angular")[0]
  .addEventListener("click", function () {
    s1 = "angular";
  });
document
  .getElementsByClassName("front angular")[1]
  .addEventListener("click", function () {
    s2 = "angular";
  });
document
  .getElementsByClassName("front php")[0]
  .addEventListener("click", function () {
    s1 = "php";
  });
document
  .getElementsByClassName("front php")[1]
  .addEventListener("click", function () {
    s2 = "php";
  });
document
  .getElementsByClassName("front python")[0]
  .addEventListener("click", function () {
    s1 = "python";
  });
document
  .getElementsByClassName("front python")[1]
  .addEventListener("click", function () {
    s2 = "python";
  });
document
  .getElementsByClassName("front sass")[0]
  .addEventListener("click", function () {
    s1 = "sass";
  });
document
  .getElementsByClassName("front sass")[1]
  .addEventListener("click", function () {
    s2 = "sass";
  });
document
  .getElementsByClassName("front html")[0]
  .addEventListener("click", function () {
    s1 = "html";
  });
document
  .getElementsByClassName("front html")[1]
  .addEventListener("click", function () {
    s2 = "html";
  });
document
  .getElementsByClassName("front reactjs")[0]
  .addEventListener("click", function () {
    s1 = "reactjs";
  });
document
  .getElementsByClassName("front reactjs")[1]
  .addEventListener("click", function () {
    s2 = "reactjs";
  });
...
function checkk() {
  ...
  if (check1 === check2 && c === 2) {
    ...
    if (s1 === s2 && s1 === "jquery") {
      document.getElementsByClassName("box jquery")[0].style.visibility =
        "hidden";
      document.getElementsByClassName("box jquery")[1].style.visibility =
        "hidden";
      score += 1;
    }
    if (s1 === s2 && s1 === "js") {
    ...
    if (s1 === s2 && s1 === "nodejs") {
      document.getElementsByClassName("box nodejs")[0].style.visibility =
        "hidden";
      document.getElementsByClassName("box nodejs")[1].style.visibility =
        "hidden";
      score += 1;
    }
    if (s1 === s2 && s1 === "php") {
    ...
    if (s1 === s2 && s1 === "angular") {
      document.getElementsByClassName("box angular")[0].style.visibility =
        "hidden";
      document.getElementsByClassName("box angular")[1].style.visibility =
        "hidden";
      score += 1;
    }
    if (s1 === s2 && s1 === "python") {
      document.getElementsByClassName("box python")[0].style.visibility =
        "hidden";
      document.getElementsByClassName("box python")[1].style.visibility =
        "hidden";
      score += 1;
    }
    if (s1 === s2 && s1 === "sass") {
      document.getElementsByClassName("box sass")[0].style.visibility =
        "hidden";
      document.getElementsByClassName("box sass")[1].style.visibility =
        "hidden";
      score += 1;
    }
    if (s1 === s2 && s1 === "html") {
      document.getElementsByClassName("box html")[0].style.visibility =
        "hidden";
      document.getElementsByClassName("box html")[1].style.visibility =
        "hidden";
      score += 1;
    }
    if (s1 === s2 && s1 === "reactjs") {
      document.getElementsByClassName("box reactjs")[0].style.visibility =
        "hidden";
      document.getElementsByClassName("box reactjs")[1].style.visibility =
        "hidden";
      score += 1;
    }
    if (score === 10) {
...
function savefasttime() {
  ...
  document.getElementsByClassName("time")[1].innerText =
    "Thời gian của bạn: " + time;
  clearInterval(timeplay);
  if (time < fasttime) {
    fasttime = time;
    document.getElementsByClassName("fasttime")[0].innerText =
      "Điểm: " + fasttime;
    document.getElementsByClassName("fasttime")[0].innerHTML =
      "Điểm cao nhất:" + fasttime;
